 ...
 * Use the [ForgotNextFragment.newInstance] factory method to
    ...
    override fun onCreateView(
        ...
        submit.setOnClickListener(View.OnClickListener {
            if(otp.text.isBlank()){
                ...
                {
                    passwordForgotInput.setError("Password Missing")
                }else{
                    if(confirmpasswordForgotInput.text.isBlank()){
                        confirmpasswordForgotInput.setError("Confirm Password Missing")
                    }else{
                        if((passwordForgotInput.text.toString()==confirmpasswordForgotInput.text.toString()))
                        {
                            if (ConnectionManager().checkConnectivity(activity as Context)) {
                                ...
                                try {
                                    ...
                                    Toast.makeText(Fcontext, "Some unexpected error occured!!!", Toast.LENGTH_SHORT).show()
                                }
                            }else
                            {
