...
class LoginFragment(val Lcontext: Context): Fragment() {
    ...
    fun userLogin()
    {
        ...
        val sharedPreferencess=Lcontext.getSharedPreferences(getString(R.string.shared_preferences),Context.MODE_PRIVATE)
            ...
            try {
                ...
                val jsonObjectRequest = object : JsonObjectRequest(
                    ...
                    Response.ErrorListener {
                        ...
                        Toast.makeText(Lcontext, "mSome Error occurred!!!", Toast.LENGTH_SHORT).show()
                ...
                Toast.makeText(Lcontext, "Some unexpected error occured!!!", Toast.LENGTH_SHORT).show()
