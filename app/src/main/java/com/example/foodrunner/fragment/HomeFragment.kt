...
class HomeFragment(val Hcontext: Context) : Fragment() {
    ...
    var restInfoList= arrayListOf<Restaurent>()



    var ratingComparator= Comparator<Restaurent> { restaurant1, restaurant2 ->

        if(restaurant1.restaurentRating.compareTo(restaurant2.restaurentRating,true)==0){
            restaurant1.restaurentName.compareTo(restaurant2.restaurentName,true)
        }
        else{
            restaurant1.restaurentRating.compareTo(restaurant2.restaurentRating,true)
        }
    }

    var costComparator= Comparator<Restaurent> { restaurant1, restaurant2 ->
