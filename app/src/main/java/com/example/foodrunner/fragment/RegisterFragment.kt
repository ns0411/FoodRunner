...
class RegisterFragment(val Rcontext : Context) : Fragment() {
    ...
    {
        val sharedPreferencess=Rcontext.getSharedPreferences(getString(R.string.shared_preferences),Context.MODE_PRIVATE)
        ...
        if (ConnectionManager().checkConnectivity(activity as Context)) {
            ...
            if (checkInputs()){
                try {
                    ...
                    val jsonObjectRequest = object : JsonObjectRequest(
                        ...
                        Response.Listener {
                            ...
                            if (success) {
                                ...
                                Toast.makeText(Rcontext, "Registered sucessfully", Toast.LENGTH_SHORT).show()
                    ...
                    Toast.makeText(Rcontext, "Some unexpected error occured!!!", Toast.LENGTH_SHORT).show()
