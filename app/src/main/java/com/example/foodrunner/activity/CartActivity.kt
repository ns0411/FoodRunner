...
class CartActivity : AppCompatActivity() {
    ...
    lateinit var activity_cart_ProgressLayout: RelativeLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activity_cart_ProgressLayout=findViewById(R.id.activity_cart_Progressdialog)
        ...
        buttonPlaceOrder.setOnClickListener(View.OnClickListener {
            ...
            if (ConnectionManager().checkConnectivity(this)) {
                ...
                activity_cart_ProgressLayout.visibility=View.VISIBLE
                ...
                try {
                    ...
                    val jsonObjectRequest = object : JsonObjectRequest(
                        ...
                        Response.Listener {
                            ...
                            activity_cart_ProgressLayout.visibility=View.INVISIBLE
                        },
                    ...
                    jsonObjectRequest.setRetryPolicy( DefaultRetryPolicy(15000, 1,
                        1f
                    )
                    )
