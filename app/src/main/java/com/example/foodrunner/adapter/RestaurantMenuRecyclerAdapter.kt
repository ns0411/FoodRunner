...
class RestaurantMenuRecyclerAdapter(val context : Context, val restaurantFoodItemList: ArrayList<RestaurentMenu>, val proceedToCartPassed:RelativeLayout, val buttonProceedToCart:Button,val restaurantId:String,val restaurantName:String):RecyclerView.Adapter<RestaurantMenuRecyclerAdapter.RestaurantMenuViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RestaurantMenuViewHolder, position: Int) {
        ...
        holder.addToCartBtn.setOnClickListener(View.OnClickListener {
            ...
            if(holder.addToCartBtn.text.toString().equals("Remove"))
            {
                    itemSelectedCount--
